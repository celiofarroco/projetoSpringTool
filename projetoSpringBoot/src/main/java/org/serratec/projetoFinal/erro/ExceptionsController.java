...
public class ExceptionsController {
	...
	public ResponseEntity<String> trataFuncionarioNotFound(FuncionarioNotFoundException e) {
		return ResponseEntity
				.notFound()
	...
	public ResponseEntity<String> trataPedidoProdutoNotFound(PedidoProdutoNotFoundException e) {
		return ResponseEntity
				.notFound()
				.header("error-code", "PEDIDO_PRODUTO_NOT_FOUND")
				.header("error-value", String.valueOf(e.getId()))
				.build();
	}
